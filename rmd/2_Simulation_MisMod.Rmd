...
# Registry
# batchtools::makeRegistry(file.dir = "r_batchtools_reg/sim/MisMod_Summary",
#                          package = c("magrittr"))
batchtools::loadRegistry(file.dir = "r_batchtools_reg/sim/MisMod_Summary",
                         writeable = TRUE)
...
tb_plot_results <- tb_results %>%
  dplyr::group_by(sd, t_missing, median_depth, method, weighted) %>%
...
ggsave(p_figure, filename = "figures/figure4/figure4.pdf",
       width = 6, height = 5)
ggsave(p_Supp, filename = "figures/suppFigure/figure4_Supp.pdf",
       width = 8, height = 8)
```