---
title: "Test if different runs improve performance"
author: "Siyuan Ma"
...
```{r batchtools}
# Registry
batchtools::makeRegistry(file.dir = "r_batchtools_reg/sim/TrueMod_Test")
batchtools::loadRegistry(file.dir = "r_batchtools_reg/sim/TrueMod_Test",
                         writeable = TRUE)
rm(list = ls())
dir_output <- "results/Simulation/TrueMod/Test"
...
# Registry
# batchtools::makeRegistry(file.dir = "r_batchtools_reg/sim/TrueMod_Summary_test",
#                          package = c("magrittr"))
batchtools::loadRegistry(file.dir = "r_batchtools_reg/sim/TrueMod_Summary_test",
                         writeable = TRUE)
rm(list = ls())
dir_output <- "results/Simulation/TrueMod/Test"
```
...
```{r summary job grid}
load(paste0(dir_output, "/tb_job.RData"))
# tb_job_finished <- tb_job %>% 
#   dplyr::filter(ceiling(i_job / n_job_each) %in% batchtools::findDone()$job.id)
