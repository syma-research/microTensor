...
```{r batchtools}
# Registry
batchtools::makeRegistry(file.dir = "r_batchtools_reg/sim/TrueMod_LessSample")
batchtools::loadRegistry(file.dir = "r_batchtools_reg/sim/TrueMod_LessSample",
                         writeable = TRUE)
rm(list = ls())
dir_output <- "results/Simulation/TrueMod/LessSample"
...
# Registry
# batchtools::makeRegistry(file.dir = "r_batchtools_reg/sim/TrueMod_Summary_LessSample",
#                          package = c("magrittr"))
batchtools::loadRegistry(file.dir = "r_batchtools_reg/sim/TrueMod_Summary_LessSample",
                         writeable = TRUE)
rm(list = ls())
dir_output <- "results/Simulation/TrueMod/LessSample"
```
